"""
NBA Season Data Collection
Collects closing spreads and scores for the entire 2025 NBA season
"""
...
def collect_season_games(sport_key: str, season_start_date: datetime = None) -> pd.DataFrame:
    ...
    Args:
        sport_key: Sport key (e.g., 'nba')
        season_start_date: Season start date (default: Oct 15, 2025 for NBA)
    ...
    if season_start_date is None:
        # Default to 2025 NBA season start
        season_start_date = datetime(2025, 10, 15, tzinfo=timezone.utc)
...
def main():
    """Main collection function - Collect entire 2025 NBA season"""
    print("="*80)
    print("COLLECTING 2025 NBA SEASON DATA")
    print("="*80)
    ...
    # Collect NBA season (Oct 15, 2025 - Today)
    sport_key = 'nba'
    season_start = datetime(2025, 10, 15, tzinfo=timezone.utc)
