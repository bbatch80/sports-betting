"""
NFL Season Data Collection
Collects closing spreads and scores for the entire 2025 NFL season
"""
...
def collect_season_games(sport_key: str, season_start_date: datetime = None) -> pd.DataFrame:
    ...
    Args:
        sport_key: Sport key (e.g., 'nfl')
        season_start_date: Season start date (default: Sept 5, 2025 for NFL)
    ...
    if season_start_date is None:
        # Default to 2025 NFL season start
        season_start_date = datetime(2025, 9, 5, tzinfo=timezone.utc)
...
def main():
    """Main collection function - Collect entire 2025 NFL season"""
    print("="*80)
    print("COLLECTING 2025 NFL SEASON DATA")
    print("="*80)
    ...
    # Collect NFL season (Sept 5, 2025 - Today)
    sport_key = 'nfl'
